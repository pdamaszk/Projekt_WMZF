...
def help_text_f3():
    if var_f3.get()==1:
        ...
        f3_label_length.config(fg=test_colours['normal'][1])
    ...
    if var_f3.get()==2:
        ...
        f3_label_length.config(fg=test_colours['off'][1])
        f3_label_bright.config(fg=test_colours['off'][1])
        return
    # if var.get()==3:
    #     Help_label.config(text="Energia kin. i pot. \n-numeryczne obliczenia, \n wykres energii poten.\n i kinet. wzgledem czasu")
    #     Help_label.config(fg=test_colours['normal'][1], font=info_font)
...
#     if checkvariables(True):
#         double_pen_ani_wyk(float(Entry_L1.get()), float(Entry_Th1.get()), float(Entry_M1.get()), float(Entry_L2.get()), float(Entry_Th2.get()), float(Entry_M2.get()))
#         plot_3D(float(Entry_L1.get()), float(Entry_L2.get()))
...
f3_label_bright.grid(row=1, column=0, sticky='nw')
...
f3_label_length = tk.Label(f3, text=" Długość śladu ",  width=0, height=0)
f3_label_length.grid(row=2, column=0, sticky='nw')
